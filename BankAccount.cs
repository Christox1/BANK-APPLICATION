...
namespace ChrisAmatuWk5
{
    public class BankAccount
    {
        ...
        private string transactionPath = @"C:\Users\Decagon\source\repos\ChrisAmatuWk5\transferDetails.json";
        ...
        public void Deposit(double amount)
        {
            ...
            else
            {
                ...
                Console.WriteLine($"Deposit of ${amount:F2}. New balance: ${Balance:F2}");
            }
        }
